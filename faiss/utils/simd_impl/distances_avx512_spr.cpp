...
// AVX512_SPR (Sapphire Rapids) distance functions.
//
// For fp32 vector utilities we reuse the AVX512 implementations;
// SPR is a strict superset of AVX-512 so results are identical.
